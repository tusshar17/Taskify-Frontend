...
export const getTasks = (page=1, per_page=6, project_id, sort_by='updated_at') => taskAPI.get(`/${project_id}/task?page=${page}&per_page=${per_page}&sort_by=${sort_by}&order=desc`)
